...
export const Hero = () => {
  ...
  style={{
    ...
    background: "linear-gradient(to right, var(--color-amber-300), var(--color-teal-300), var(--color-violet-400), var(--color-fuchsia-400))", // Gradient colors
  }}
></span>
            ...
            <Planet size="lg" color="violet" className="-translate-x-[278px] -translate-y-[80px] rotate-135"/>
            <Planet size="lg" color="violet" className="-translate-y-[176.9px] translate-x-[268px] -rotate-135"/>
            <Planet size="sm" color="fuchsia" className="-translate-y-[270px] -translate-x-[450px] rotate-135"/>
            <Planet size="md" color="teal" className="-translate-y-[270px] translate-x-[420px] -rotate-135"/>
              ...
              <div className="absolute left-0 z-10 top-[30%] -translate-x-10 hidden lg:block"> 
                <div className="bg-gray-800/70 backdrop-blur-md border border-gray-700 rounded-xl p-4 w-72">
                  <div>What exactly is AI4Impact? I've heard about it and would love to know more! </div>
              ...
              <div className="absolute right-0 z-10 top-[50%] translate-x-10 hidden lg:block"> 
                <div className="bg-gray-800/70 backdrop-blur-md border border-gray-700 rounded-xl p-4 w-72">
                  <div>
                    <strong>BrainZ:</strong> AI4Impact is a platform where students collaborate to use the power of AI for social good with creative AI-driven solutions.
                  </div>
