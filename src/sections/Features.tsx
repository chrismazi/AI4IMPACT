...
export const features = [
  ...
  "Innovate Solutions for Real Challenges",
  "Collaborate to Make a Difference",
];

export const logos = [
  { src: slackLogo, alt: "slack logo", rotate: 0 },
  { src: dockerLogo, alt: "docker logo", rotate: 45 },
  { src: figmaLogo, alt: "figma logo", rotate: 90 },
  { src: githubLogo, alt: "github logo", rotate: 135 },
  { src: vsCodeLogo, alt: "vs code logo", rotate: 180 },
  { src: notionLogo, alt: "notion logo", rotate: 225 },
  { src: jiraLogo, alt: "jira logo", rotate: 270 },
  { src: gcpLogo, alt: "gcp logo", rotate: 315 },
];
